...
contract MiniDAI is ERC20 {
    ...
    constructor(
        ...
        address _USTUSDAddress
    ) ERC20(name, symbol) {
        USTUSD = IERC20(_USTUSDAddress);
    }
    ...
    function mint(address to, uint256 amount) external {
        require(USTUSD.transferFrom(msg.sender, address(this), amount), "USTUSD transfer failed");
        _mint(to, amount);
    ...
    function burn(address from, uint256 amount) external {
        ...
        require(USTUSD.transfer(from, amount), "USTUSD transfer failed");
        _burn(from, amount);
